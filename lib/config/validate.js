 ...
 * @return {Boolean} validated boolean type
 */
...
var mergeDefaults = exports.mergeDefaults = function(conf) {
  ...
  // merge
  var ret = merge(defaults.conf, conf, m);

  // create controllerfuncname if not explicitly set
  ret.controllerfuncname = defaults.controllerfuncname(ret);
