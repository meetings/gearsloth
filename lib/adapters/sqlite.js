...
var __table_name    = 'DelayedTasks';
var __database_file = '/var/lib/gearsloth/tasks.sqlite';
...
function SQLiteAdapter(config, callback) {
  ...
  this.table = config.dbopt.table_name || __table_name;
  this.database = config.dbopt.database_file || __database_file;
