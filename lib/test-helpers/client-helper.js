...
var submit_func_for_job = exports.submit_func_with_json_payload_to_port_and_return_job = function( func_name, payload, port ) {
...
var submit_func = exports.submit_func_with_json_payload_to_port_and_wait_for_completion = function( func_name, payload, port, callback ) {
  ...
  job.on( 'complete', function() { callback() } );
...
var submit_jof_for_job = exports.submit_delayed_job_to_port_and_return_job = function( job, port ) {
  return submit_func_for_job( delayed_job_function_name, job, port );
}

var submit_job = exports.submit_delayed_job_to_port_and_wait_for_completion = function( job, port, callback ) {
