...
test('two of two, and one is brought up, immediate task is executed', function(done) {
    this.timeout(10000);
    async.series([
      function(callback_outer) {
        async.series([
      ...
      function(callback_outer) {
        async.series([
          ...
          function(callback) {
            ejector_container2.kill(function(){
              ejector_container2.remove(function() {
                callback();
              });
            });
          },
